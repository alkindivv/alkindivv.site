  ...
  return (
    <Layout>
      <SEO
        ...
        description="Kumpulan istilah hukum yang sering digunakan dalam praktik hukum di Indonesia."
      />
              ...
              <div className="flex-1  mx-auto lg:mx-0">
                ...
                <div className="space-y-4" data-fade="5">
                  {filteredTerms.map((item) => (
                    <div
                      key={item.term}
                      className="group transition-all duration-200 transform hover:translate-y-[-2px]"
                    >
                      <button
                        onClick={() =>
                          setExpandedTerm(
                        ...
                        className="w-full flex items-center justify-between p-4 border border-gray-900
                                rounded-lg hover:border-emerald-500/20 transition-colors text-left"
                      >
