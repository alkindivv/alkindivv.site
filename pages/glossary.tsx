  ...
  return (
    <Layout title="Legal Glossary | AL KINDI" isHomePage={false}>
      <PowerfulSEO
        ...
        description="Comprehensive legal glossary covering corporate law, capital markets, M&A, bankruptcy, and cryptocurrency terms. Essential reference for legal professionals."
