    ...
    <Layout title="Wishlist | AL KINDI" isHomePage={false}>
      ...
      <main className="min-h-screen pt-40 relative z-10">
        <div className="container max-w-3xl mx-auto px-4">
          {/* Header */}
          <div className="mt-14 relative space-y-4 text-center" data-fade="1">
          ...
          <div
            className="h-px bg-gradient-to-r from-transparent via-gray-800 to-transparent mb-14 mt-3"
            data-fade="2"
          />

          {/* Content */}
          <div className="mt-20 mx-auto" data-fade="2">
