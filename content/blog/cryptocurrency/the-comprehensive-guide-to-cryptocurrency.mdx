...
seo:
  ...
  canonicalUrl: 'https://alkindi.id/blog/cryptocurrency/the-comprehensive-guide-to-cryptocurrency'
...
<ImageGrid
  images={[
    { src: '/images/AL-KINDI.png', alt: 'Deskripsi gambar 1' },
    { src: '/images/AL-KINDI.png', alt: 'Deskripsi gambar 2' },
  ]}
  caption="Caption opsional untuk grid gambar ini"
/>
