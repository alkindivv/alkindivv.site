...
1. **_Transactions:_** When a user sends or receives <DimensionLink href="#">cryptocurrency</DimensionLink>, the transaction is added to the blockchain. Each transaction is bundled into a block
